...
if (mysqli_num_rows($result0) > 0) {
    while($row0 = mysqli_fetch_assoc($result0)) {
        ...
        if($type == "ac" && $charge_type == "km") {
            $fare = $row0["ac_price"];
        } elseif ($type == "ac" && $charge_type == "days") {
            $fare = $row0["ac_price_per_day"];
        } elseif ($type == "non_ac" && $charge_type == "km") {
            $fare = $row0["non_ac_price"];
        } elseif ($type == "non_ac" && $charge_type == "days") {
...
if($err_date >= 0) {
    ...
    <h3 class="text-center"> <strong>Your Order Number:</strong> <span
            style="color: blue;"><?php echo "$id"; ?></span> </h3>
    ...
    if($charge_type == "days") {
        ?>
                ...
                <br>
                <h4> <strong>Driver Name: </strong>
                    <?php echo $driver_name; ?>
                </h4>
                <br>
                <h4> <strong>Driver Gender: </strong>
                ...
                <br>
                <h4> <strong>Driver Contact:</strong>
                    <?php echo $driver_phone; ?>
                </h4>
                <br>
                <h4> <strong>Employee Name:</strong>
