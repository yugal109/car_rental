                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-8 col-md-offset-2">
                            <h1 class="brand-heading" style="color: black">Enzy Rentals</h1>
                            <p class="intro-text">
        ...
        ?>
            <a href="booking.php?id=<?php echo($car_id) ?>">
                <div class="sub-menu">
                    ...
                    <h6> AC Fare:
                        <?php echo("Rs. " . $ac_price . "/km & Rs." . $ac_price_per_day . "/day"); ?>
                    </h6>
                    <h6> Non-AC Fare:
                        <?php echo("Rs. " . $non_ac_price . "/km & Rs." . $non_ac_price_per_day . "/day"); ?>
                    </h6>
