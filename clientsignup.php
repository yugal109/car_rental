...
<head>
    <title> Employee Signup | Enzy Rentals </title>
</head>
...
<body>
    ...
    <div class="container">
        <div class="jumbotron">
            <h1 class="text-center">Enzy Rentals - Registration</h1>
            <br>
            ...
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    ...
                    <form role="form" action="client_registered_success.php" method="POST">
                        ...
                        <div class="row">
                            <div class="form-group col-xs-12">
                                <label for="client_phone"><span class="text-danger" style="margin-right: 5px;">*</span>
                                    Phone: </label>
                                <div class="input-group">
